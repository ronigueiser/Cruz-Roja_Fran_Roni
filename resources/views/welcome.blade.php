...
<section class="container">
    ...
    <div class="d-flex cont-1">
        ...
        <div>
        <p>Somos una asociación civil, humanitaria y de carácter voluntario, con presencia en el territorio argentino, y
            parte integrante del
            Movimiento Internacional de la Cruz Roja y de la Media Luna Roja, la red humanitaria más grande del mundo
    ...
    <div class="col-4">
        ...
        <p>
            ...
            construyendo y fortaleciendo las capacidades locales, fomentando la inclusión y participación de todos los
    ...
    <div class="col-4">
        ...
        <p>Desde Cruz Roja estamos presentes en cada gran emergencia, cuando ocurre el desastre y después, cuando los
            hechos dejan de ser noticia.</p>
    </div>

    <div class="col-4">
        <h2>Programas y Servicios</h2>
        <p>A través de nuestros distintos programas y servicios educativos, deseamos construir una sociedad más justa y
    ...
    <div class="col-6">
        ...
        <p>
            Trabajamos en la promoción de la salud y el desarrollo comunitario, reforzando la prevención de enfermedades
...
<section class="row">
    ...
    <p>Desde Cruz Roja nos enfocamos en agrandar nuestra comunidad y tener más gente con conocimiento en las calles.
        ...
        Tenemos distintos cursos en los que te podés inscribir y así ser parte de un movimiento que prioriza la salud y
